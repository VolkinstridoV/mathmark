...
@Composable
fun KindGlyph(kind: FileKind, colors: MathMarkColors, size: Dp = 42.dp) {
...
@Composable
fun FolderGlyph(colors: MathMarkColors, size: Dp = 42.dp) {
    Canvas(Modifier.size(size)) {
...
private fun DrawScope.plate(colors: MathMarkColors, deeper: Boolean) {
...
@Composable
fun RootMark(colors: MathMarkColors, size: Dp = 64.dp) {
    Canvas(Modifier.size(size)) {
