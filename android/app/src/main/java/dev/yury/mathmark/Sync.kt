 ...
 * ошибка здесь портит файлы человека, а не рисует кривую кнопку.
 *
 * Разморозка — одна строка: поставить false. То же самое лежит в `sync.py`
 * настольной версии, снимать надо обе разом, иначе стороны разойдутся.
 */
const val SYNC_FROZEN = true
