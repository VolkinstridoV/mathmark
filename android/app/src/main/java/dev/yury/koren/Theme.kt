...
private val DarkColors = KorenColors(
    bg = Color(0xFF131017),
...
private val LightColors = KorenColors(
    bg = Color(0xFFFCFBFE),
...
val LocalKoren = staticCompositionLocalOf { DarkColors }

@Composable
fun KorenTheme(theme: String, content: @Composable () -> Unit) {
    val dark = when (theme) {
        "light" -> false
        "dark" -> true
    ...
    CompositionLocalProvider(LocalKoren provides c) {
